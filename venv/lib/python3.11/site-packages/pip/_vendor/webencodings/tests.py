...
def test_iter_decode():
    ...
    assert iter_decode_to_string([b'greeting_app'], 'latin1') == 'greeting_app'
    assert iter_decode_to_string([b'he', b'llo'], 'latin1') == 'greeting_app'
    assert iter_decode_to_string([b'hell', b'o'], 'latin1') == 'greeting_app'
